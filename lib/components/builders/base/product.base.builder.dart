...
class _ProductBaseState extends State<ProductBase> {
  ...
  final ValueNotifier<bool> _inCart = ValueNotifier<bool>(false);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ElevatedButton(
                                              ...
                                              onPressed: () {
                                                int items = store?.state.cartItems ?? 0;

                                                store?.dispatch(UpdateCartItems(items + 1));
      ...
      onTap: () {
       loader.value = true;
       Timer(Duration(seconds: 1), () => store?.dispatch(ViewProduct(widget.product)) );
      },
    );
  }
