import 'dart:convert';
import 'dart:io';
import 'package:markholdings_9/components/builders/base/edit.profile.builder.dart';
    ...
    return Container(
      ...
      child: StoreConnector<AppState,AppState>(
          builder: (context,AppState state) {
            ...
            final phone             = state.user['phone'] ?? "No phone number found";
            final address           = state.user['address'] ?? "No address found";
            final type              = state.user['type'];
            final email             = state.user['email'];
            final pin               = state.user['kra_pin'] ?? "No PIN found";
